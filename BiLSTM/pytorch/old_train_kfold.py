...
model_layer_num = 16     # number of recurrent layers
...
def train_model(model, kFolds_num, epochs_num, batch_size, criterion):
    ...
    for epoch in range(epochs_num):
        ...
        loader = torch.utils.data.DataLoader(dataset, batch_size = 4000, shuffle=False)
        ...
        for data_subset, label_subset in loader:
            ...
            for fold, (train_indexs, valid_indexs) in enumerate(kFold.split(data_subset, label_subset)):
                ...
                for inputs, labels in trainLoader:
                    ...
                    accuracy_fold += count_accuracy(model_out, labels)
                ...
                with torch.no_grad():
                    ...
                    for valid_inputs, label in validLoader:
                        ...
                        correct += count_accuracy(model_out, label)
...
train_model(model, kFolds_num, epochs_num, batch_size, criterion)
